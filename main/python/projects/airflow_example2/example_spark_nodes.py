...
class LocaleHeights2(BaseTableNode):
    """
...
class CountryHeights2(BaseTableNode):
    """
    ...
    def set_dependencies(self):
        self.dependency_list = [
            LocaleHeights2(self.configuration, period_offset=tu.previous()),
...
class CountryHeightsCount2(BaseTableNode):
    """
    ...
    def set_dependencies(self):
        self.dependency_list = [
            CountryHeights2(self.configuration, period_offset=tu.current()),
        ]
